            ...
            <div class="header-bottom-wrapper">
                <div class="header-bottom">
                    ...
                    <div class="selectable">
                        ...
                        <div class="options-holder">
                            <div class="options">
                                <a href="#" class="header-bottom-option">Правила приема</a>
                                <a href="#" class="header-bottom-option">Специальности</a> 
                                <a href="#" class="header-bottom-option">Наши реквизиты</a> 
                                <a href="#" class="header-bottom-option">Перечень документов</a> 
                            </div>
                        </div>
                    </div>
                    <div class="selectable">
