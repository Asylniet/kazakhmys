        ...
        <header class="flex column">
                ...
                <div class="header-top">
                    ...
                    <div class="locationWrapper">
                        ...
                        <div class="flex g20 additionalLinksWrapper">
                            <a href="/pages/staff/index.html" class="additionalLink">Педагогический состав</a>
                            <a href="/pages/projects/index.html" class="additionalLink">Проекты</a>
                            <a href="/pages/divisions/index.html" class="additionalLink">Подразделения</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="header-middle">
                <a href="/" class="logo-image-link">
                    <img src="/assests/images/logo.png" alt="logo" class="logo-image">
                </a>
                <div class="header-middle-info contact1">
                    <img src="/assests/icons/phone${transparent && widthCheck ? '-white' : ''}.svg" alt="phone">
                    <span>Приемная:</span>
                    <a href="tel:87103668407" class="underline-hover">+7 (710) 366-84-07</a>
                </div>
                <div class="header-middle-info contact2">
                    <img src="/assests/icons/phone${transparent && widthCheck ? '-white' : ''}.svg" alt="phone2">
                ...
                <div class="contact3-wrapper">
                    <div class="header-middle-info contact3">
                        <img src="/assests/icons/email${transparent && widthCheck ? '-white' : ''}.svg" alt="mail" class="mailIcon">
            ...
            <div class="header-bottom-wrapper">
                <div class="header-bottom">
                    ...
                    <div class="selectable">
                        ...
                        <div class="options-holder">
                            <div class="options">
                                <a href="/pages/enrollee/admission.html" class="header-bottom-option">Правила приема</a>
                                <a href="/pages/enrollee/specialities.html" class="header-bottom-option">Специальности</a> 
                                <a href="/pages/enrollee/requisites.html" class="header-bottom-option">Наши реквизиты</a> 
                                <a href="/pages/enrollee/document.html" class="header-bottom-option">Перечень документов</a> 
                            </div>
                        </div>
                    </div>
                    <div class="selectable">
                    ...
                    <div class="selectable">
                        ...
                        <div class="options-holder">
                            <div class="options">
                                ...
                                <a href="/pages/employment/practice.html" class="header-bottom-option">Практика</a> 
                                <a href="/pages/employment/vacancies.html" class="header-bottom-option">Вакансии</a> 
                            </div>
                        </div>
                    </div>
                    <a href="/pages/education/index.html" class="just-link">Обучение</a>
                    <a href="/pages/directors-blog/index.html" class="just-link">Блог Директора</a>
                </div>
            </div>
        </header>
    `;
