                ...
                <div class="header-top">
                    ...
                    <div class="actual-header-top">
                        ...
                        <div class="flex g20 additionalLinksWrapper">
                            ...
                            <a href="" class="additionalLink">Проекты</a>
                    ...
                    <div class="selectable">
                        ...
                        <div class="options-holder">
                            <div class="options">
                                ...
                                <a href="#" class="header-bottom-option">Практика</a> 
                                <a href="#" class="header-bottom-option">Вакансии</a> 
                            </div>
                        </div>
                    </div>
                    <div class="selectable">
                        ...
                        <div class="options-holder">
                            <div class="options">
                                <a href="#" class="header-bottom-option">Дистанционное обучение</a>
                                <a href="#" class="header-bottom-option">Дуальное обучение</a> 
                                <a href="#" class="header-bottom-option">Заочное обучение</a> 
                                <a href="#" class="header-bottom-option">Лицензия</a> 
                            </div>
                        </div>
                    </div>
                    <a href="" class="just-link">Блог Директора</a>
                </div>
            </div>
        </header>
    `;
