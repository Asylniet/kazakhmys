        ...
        <header class="flex column">
            ...
            <div class="header-middle">
                ...
                <div class="header-middle-info contact1">
                    <img src="/assests/icons/phone${transparent ? '-white' : ''}.svg" alt="phone">
                    <span>Приемная:</span>
                    <a href="tel:87103668407" class="underline-hover">+7 (710) 366-84-07</a>
                </div>
                <div class="header-middle-info contact2">
                    <img src="/assests/icons/phone${transparent ? '-white' : ''}.svg" alt="phone2">
                ...
                <div class="contact3-wrapper">
                    <div class="header-middle-info contact3">
                        <img src="/assests/icons/email${transparent ? '-white' : ''}.svg" alt="mail" class="mailIcon">
            ...
            <div class="header-bottom-wrapper">
                <div class="header-bottom">
                    <div class="selectable">
                        <a href="/pages/about/index.html" class="selected">
                    ...
                    <div class="selectable">
                        <a href="/pages/enrollee/index.html" class="selected">
